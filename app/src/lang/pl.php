...
return [
    ...
    'nav.menu'            => 'Nawigacja',
    // Sesja 3,5 — szyna boczna, górny pasek, pulpit.
    'nav.close'           => 'Zamknij nawigację',
    'nav.grp.club'        => 'Klub',
    'nav.grp.tools'       => 'Narzędzia',
    'nav.grp.admin'       => 'Administracja',
    'nav.team'            => 'Drużyna',
    ...
    // --- import meczu n+1: meta i diff (Sesja 6) ---
    'meta.title'          => 'Dane meczu',
    'meta.crumb'          => 'Dane meczu',
    'meta.lead'           => 'Uzupełnij opis meczu, zanim powstanie raport. Nazwa Twojej drużyny bierze się z klubu i nie trzeba jej wpisywać.',
    'meta.rival'          => 'Rywal',
    'meta.rival.none'     => '— nie wybrano',
    'meta.rival.hint'     => 'Wybierz z listy. Rywal jest wpisem w bazie klubów, więc niesie herb, barwy i nazwy z eksportów — dzięki temu następny mecz z nim rozpozna się sam.',
    'meta.rival.new'      => 'Albo załóż nowego rywala',
    'meta.rival.new.hint' => 'Wypełnij tylko wtedy, gdy rywala nie ma na liście. Nazwa trafi też do nazw rozpoznawanych w eksportach. Jeśli klub o tej nazwie już istnieje, użyjemy istniejącego zamiast tworzyć bliźniaka.',
    'meta.where'          => 'Gdzie grany',
    'meta.where.unknown'  => 'nie wiemy',
    'meta.where.home'     => 'u siebie',
    'meta.where.away'     => 'na wyjeździe',
    'meta.score_us'       => 'Bramki — nasza drużyna',
    ...
    // SKĄD dane przyjdą — nie wymyślona liczba (CLAUDE.md §8).
    'dash.more'           => 'więcej',
    'dash.open'           => 'otwórz',
    ...
    'dash.kpi.sbz'        => 'SBZ na mecz',
    'dash.kpi.press'      => 'Pressing skuteczny',
    ...
    'dash.report'         => 'Raport',
    'dash.slides'         => 'Slajdy',
    'dash.recalc'         => 'Przelicz',
    'dash.legend.win'     => 'wygrana',
    'dash.legend.draw'    => 'remis',
    'dash.legend.loss'    => 'porażka',
    'dash.legend.next'    => 'przed nami',
    'dash.col.round'      => 'Kolejka',
    'dash.col.match'      => 'Mecz',
    'dash.col.result'     => 'Wynik',
    'dash.col.xg'         => 'xG',
    'dash.col.shots'      => 'Strzały',
    'dash.col.sbz'        => 'SBZ',
    'dash.col.status'     => 'Status',
    'dash.col.actions'    => 'Akcje',
    'dash.pill.import'    => 'Import',
    'dash.pill.report'    => 'Raport',
    'dash.pill.link'      => 'Link',
    'dash.filter.season'  => 'Sezon',
    'dash.filter.status'  => 'Status',
    'dash.filter.apply'   => 'Filtruj',
    'dash.filter.all'     => 'Wszystkie',
    'soon.title'          => 'Wkrótce',
